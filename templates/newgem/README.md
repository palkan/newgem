[![Gem Version](https://badge.fury.io/rb/<%= name %>.svg)](https://rubygems.org/gems/<%= name %>) [![Build](https://github.com/palkan/<%= name %>/workflows/Build/badge.svg)](https://github.com/palkan/<%= name %>/actions)
